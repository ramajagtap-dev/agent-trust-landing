  ...
  return (
    <section className="py-16 md:py-24 px-6 max-w-6xl mx-auto text-center">
      ...
      <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-emerald-950/60 border border-emerald-800/80 text-emerald-400 text-xs font-medium mb-6 shadow-glow-green">
        <ShieldCheck className="w-4 h-4" /> Pre-Install Trust Layer & Benchmarking Framework
      </div>
      ...
      <div className="flex flex-col sm:flex-row justify-center gap-4 mb-14">
        <a href="#benchmark" className="bg-emerald-500 hover:bg-emerald-600 text-black font-semibold px-6 py-3 rounded-lg flex items-center justify-center gap-2 transition shadow-glow-green">
          Explore Benchmarks <Play className="w-4 h-4 fill-black" />
        </a>
        <a href="#how-it-works" className="border border-slate-800 hover:border-slate-700 bg-slate-900/50 text-gray-300 font-medium px-6 py-3 rounded-lg transition">
          View Workflow
        </a>
      </div>
      ...
      <div className="bg-slate-950 border border-slate-800 rounded-xl overflow-hidden shadow-2xl max-w-3xl mx-auto text-left font-mono text-xs sm:text-sm">
        <div className="bg-slate-900/90 px-4 py-2.5 border-b border-slate-800 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-gray-400 ml-2">agent-trust-interceptor — real-time log</span>
          </div>
        ...
        <div className="p-5 space-y-3 bg-slate-950/90">
          <p className="text-gray-400"><span className="text-emerald-400">$</span> cursor-agent install <span className="text-amber-300">package-hallucinator-lib</span></p>
          ...
          <div className="flex items-center gap-2 text-red-400 font-semibold text-xs sm:text-sm">
            <XCircle className="w-4 h-4" /> [ACTION] Installation Intercepted & Blocked
          </div>
          <div className="flex items-center gap-2 text-emerald-400 text-xs sm:text-sm">
            <CheckCircle className="w-4 h-4" /> [CLOSED-LOOP RECOVERY] Agent switched to verified package: <span className="underline">popular-secure-lib</span>
          </div>
        </div>
      </div>
      ...
      <div className="flex justify-center gap-3 mt-4 text-[11px] font-mono">
        <span className="px-3 py-1 rounded bg-emerald-950/60 border border-emerald-800 text-emerald-400">ALLOW</span>
        <span className="px-3 py-1 rounded bg-amber-950/60 border border-amber-800 text-amber-400">WARN</span>
        <span className="px-3 py-1 rounded bg-red-950/60 border border-red-800 text-red-400">BLOCK</span>
      </div>
    </section>
  );
}